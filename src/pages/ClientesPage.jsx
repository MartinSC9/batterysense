  ...
  const [clientes] = useState([
    {
      ...
      alarms: 2,
      status: 'warning',
      ultimaLectura: '30/01/2026 14:30',
      contacto: 'Juan Pérez',
      email: 'contacto@empresaabc.com',
    },
    {
      id: 2,
      nombre: 'Telecomunicaciones XYZ',
      ubicacion: 'Córdoba, Argentina',
      bancos: 5,
      sensores: 78,
      alarms: 0,
      status: 'normal',
      ultimaLectura: '30/01/2026 14:28',
      contacto: 'María García',
      email: 'soporte@telexyz.com',
    },
    {
      id: 3,
      nombre: 'Data Center Plus',
      ubicacion: 'Mendoza, Argentina',
      bancos: 8,
      sensores: 120,
      alarms: 5,
      status: 'critical',
      ultimaLectura: '30/01/2026 14:25',
      contacto: 'Carlos López',
      email: 'admin@datacenterplus.com',
    },
    {
      id: 4,
      nombre: 'Energía Renovable SA',
      ubicacion: 'Rosario, Argentina',
      bancos: 2,
      sensores: 24,
      alarms: 0,
      status: 'normal',
      ultimaLectura: '30/01/2026 14:20',
      contacto: 'Ana Martínez',
      email: 'info@energiarenovable.com',
    },
  ]);
